...
{
    private GameTimer timer; //定时器
    
    //skill:使用过的技能 targets:技能的目标 callback:技能的回调
    ...
    //添加技能
    public void AddSkill(ISkill skill, List<ModelBase> targets, System.Action callback = null)
    {
